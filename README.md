...
For the second stage of the project, json data is now being fetched from a local API server. Restaurants and reviews are being stored in IndexedDB for offline use.
